package org.oucho.mpdclient.widgets.fastscroll;
...
public class FastScroller extends LinearLayout implements MPDConfig {
    ...
    private static boolean voirBubulle = true;

    public static void setVoirBubulle(boolean value) {
