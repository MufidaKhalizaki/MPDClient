package org.oucho.mpdclient.bugDroid;
...
public class IMMLeaks {
    ...
    static class ReferenceCleaner
        ...
        private void clearInputMethodManagerLeak() {
            ...
            } catch (IllegalAccessException | InvocationTargetException | NullPointerException unexpected) {
                Log.w("IMMLeaks", "Unexpected reflection exception", unexpected);
            }
        }
